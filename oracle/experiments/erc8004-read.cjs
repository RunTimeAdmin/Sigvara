...
// Reputation Registry and compute a Sigvara externalScore (0-15) from it.
//
...
// the value layer Sigvara provides. This script proves the read + that
...
async function main() {
  ...
  console.log(`\nSigvara externalScore: ${externalScore} / 15`);
