...
/**
 * @title SVR
 * @notice Mainnet $SVR — the fixed-supply work token of Sigvara.
 *
 *         1,000,000,000 SVR is minted once, in this constructor, and distributed
 ...
 *
 *         This is distinct from the testnet SVRToken (which is owner-mintable and
 ...
 *         other contracts transferring to address(0xdead), matching SigvaraStaking.
 *         The token therefore exposes no burn() surface of its own.
 */
contract SVR is ERC20 {
    /// Immutable total supply: 1 billion SVR (18 decimals).
