...
contract SigvaraReputationTest is Test, RegistrationHelper {
    ...
    //
    // Generated by scripts/check-evidence-fixture.mjs, which holds the three payments and
    // runs as a gate. These were four bare hashes with no record of the inputs, so nobody
    // could regenerate them or tell whether a leaf-format change had invalidated them.
    // Rerun that script with --write after a deliberate format change.
    bytes32 constant EV_ROOT  = 0x451c84f85bd641fa21b4ff72cc97793d70258dcd313619ea295b1726d9fde77b;
    bytes32 constant EV_LEAF0 = 0xaf246e3218af3bbced1bfe7bd7fbb749c46d3204c7ccba8336bbd2dc2cc35eac;
    bytes32 constant EV_LEAF1 = 0xa751e3a8b1b3e848976c2ea4db10561b891d6a063f046781ace7a9736c63cb3e;
    bytes32 constant EV_LEAF2 = 0x113b7fe4c7051bace5d163eef6eba3b2e609d8e104a5f8e723b57430419a5347;
    ...
    function _proof2() internal pure returns (bytes32[] memory p) {
        p = new bytes32[](1);
        p[0] = 0xa657482e440e73b86cc967dc7c6b45463fc97d879bffa11be705d6d13742cfc6;
    }
